...
export class UserInit extends Component<UserInitProps, UserInitState> {
  ...
  getClassName(color: string): string | undefined {
    if (color === this.state.color) return 'bc_' + color + ' color_selected';
  ...
  render() {
    return (
      <div className="background">
        {/* Redirect to home */}
        {this.state.redirect ? (
          <Navigate to={{ pathname: process.env.REACT_APP_HOME }} />
        ) : null}
          ...
          >
            ...
            <Grid item xs={3} className="grid_item_style">
              ...
              >
                ...
                <Grid item xs={8} className="grid_item_style">
                  <input
                    autoFocus
                    id="unstyled"
                    maxLength={10}
            ...
            <Grid item xs={3} className="grid_item_style">
              ...
              >
                ...
                <Grid item xs={8} className="grid_item_style">
                  ...
                  >
                    <div
                      className={'colors_button ' + this.getClassName('green')}
                      onClick={() => {
                        this.onClick('green');
                      }}
                    />
                    <div
                      className={'colors_button ' + this.getClassName('red')}
                      onClick={() => {
                        this.onClick('red');
                      }}
                    />
                    <div
                      className={'colors_button ' + this.getClassName('pink')}
                      onClick={() => {
                        this.onClick('pink');
                      }}
                    />
                    <div
                      className={'colors_button ' + this.getClassName('yellow')}
                      onClick={() => {
                        this.onClick('yellow');
                      }}
                    />
                    <div
                      className={'colors_button ' + this.getClassName('white')}
                      onClick={() => {
                        this.onClick('white');
                      }}
                    />
                    <div
                      className={'colors_button ' + this.getClassName('cyan')}
                      onClick={() => {
                        this.onClick('cyan');
                      }}
                    />
